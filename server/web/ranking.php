...
?>
	  ...
	  <div style="background:url(../images/servidor.png) no-repeat;"><div class='memin'><a href="rankingpvp.php"><img src="images/ranking_pvp.png" width="200" height="44" /></a></div>
	  <div class='memin'></div><br></br><br></br></span>
</div>
</div>
...
// keeps getting the next row until there are no more to get
		...
		while($row = mysql_fetch_array( $result )) {
			...
			$ranks = $row['Rank'];
			echo "<tr><th bgcolor=''>"; 
			echo "<font class='form-button'>$order1</font>";
			echo "</td><th bgcolor=''>"; 
...
/* SQL QUERY AND LOOP COMMENTED OUT FOR VIEW MODE
...
or die(mysql_error());
		...
		while($row = mysql_fetch_array( $result2 )) {
			...
			$rankv = $row['Rank'];
			echo "<tr><th bgcolor=''>"; 
			echo "<font class='form-button'>$order2</font>";
			echo "</td><th bgcolor=''>"; 
			echo "<font color='#60B3D2'>$nombre</font>";
			echo "</td><th bgcolor=''>"; 
			echo "<font color='#60B3D2'>$nivel</font>";
...
/* DATABASE LOOP COMMENTED OUT FOR VIEW MODE
		...
		while($row = mysql_fetch_array( $result3 )) {
			...
			$ranko = $row['Rank'];
			echo "<tr><th bgcolor=''>"; 
			echo "<font class='form-button'>$order3</font>";
			echo "</td><th bgcolor=''>"; 
			echo "<font color='#60B3D2'>$nombre</font>";
			echo "</td><th bgcolor=''>"; 
			echo "<font color='#60B3D2'>$nivel</font>";
