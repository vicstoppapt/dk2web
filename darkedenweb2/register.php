...
<script src="SpryAssets/SpryTabbedPanels.js" type="text/javascript"></script><script type="text/javascript">

function fhead_submit(f) {
	if (!f.mb_id.value) {
        alert("Introdusca un ID de usuario");
        f.mb_id.focus();
        return false;
    }
    if (!f.mb_password.value) {
        alert("Introdusca una COntrasena");
        f.mb_password.focus();
        return false;
    }
...
function doLogout() {
    if(confirm("Estas realmente seguro de que desea cerrar la sesion?")==true) {
...
<div style="background:url(../images/servidor.png) no-repeat;"><div class='memin'></div><div class='memin'></div><br></br><br></br></span>
    ...
    <div id="content-middle">
      <div id="container">
      <div id="wrapper">
      <form method=post action=register_do.php onSubmit="return chk_form();" > 
<input type="hidden" name=Security value="1">
<input type="hidden" name=SET value="<?=$SET?>">
      <table width="100%" border="0" cellspacing="3" cellpadding="3">
				<tr>
					<td width="21%" align="right" class="mamone" title="User.">username:</td>
				<td width="79%"><span class="list">
				  <input name="username" type="text" class="input_text" style="ime-mode:disabled" maxlength="30" />
				</span></td>
			</tr>
				<tr>
					<td align="right" class="mamone" title="Password.">password</td>
					<td><span class="list">
					  <input name="pass" type="password" class="input_text" style="ime-mode:disabled" autocomplete="off" maxlength="10" />
				  </span></td>
				</tr>
				<tr>
					<td align="right" class="mamone" title="Repeat password.">repeat password:</td>
					<td><span class="list">
					  <input name="vpass" type="password" class="input-text" style="ime-mode:disabled" autocomplete="off" maxlength="10" />
				  </span></td>
				</tr>
				<tr>
					<td align="right" class="mamone" title="Site Password.">SSN:</td>
					<td><span class="list">
					  <input name="pin1" type="number" class="input_text" style="ime-mode:disabled"  maxlength="7" />
					</span></td>
				</tr>
				<tr>
					<td align="right" class="mamone" title="Repeat site password.">repeat ssn:</td>
					<td><span class="list">
					  <input name="pin2" type="number" class="input_text" style="ime-mode:disabled" min="7" maxlength="7" />
					</span></td>
				</tr>
				<tr>
					<td align="right" class="mamone">E-Mail:</td>
					<td><span class="list">
					  <input name="correo" type="correo" class="input_text" style="ime-mode:disabled" min="5" maxlength="30" />
				  </span></td>
				</tr>
				<tr>
          	</tr>
          	<tr>
            	<td align="sight" class="mamone"><span id="result_box2" lang="en" xml:lang="en">Terms of Service</span>:</td><br></br>
            	<td>
                	<div style="width:350px; border:1px solid #000000; background:#444444; padding:5px; height:120px; overflow:auto;">
                    ﻿<p><span id="result_box" lang="en" xml:lang="en">Terms and Conditions of Service<br />
                        <br />
                        Server stats &amp; Rules<br />
                        <br />
                        Exp rate: 30x<br />
                        <br />
                        Rank Exp rate: 7x<br />
                        ...
                        Pet Exp rate: 6x<br />
                        <br />
                        Drop rate of items: 70x<br />
                        <br />
                        Drop rate of rare items: 30x<br />
                        <br />
                        <br />
                        <br />
                        Market Info:<br />
                        <br />
                        1000 Pts Pts 10 $ 2,000 $ 20<br />
                        <br />
                        3000 Pts $ 30<br />
                        <br />
                        4000 Pts $ 40<br />
                        ...
                        Server Rules:<br />
                        <br />
                        You must agree to these rules before playing on our server. We do not want any miscommunication that happened between our players and our GMS. 1. SpeedHacker use is prohibited and will be punished with permanent ban of the account. This means loss of money market. 2. User who found bug in the game and take advantage of the mind will be permanently banned.<br />
                        <br />
                        3. The verbal attack a user is prohibited and may be permanently banned from this includes (Racism).<br />
                        <br />
                        4. The management team is not allowed to teletrasportar users.<br />
                        <br />
                        5. If a GM does not meet the rules you are within their rights to report it to the forum.</span></p>
                    </div><br></br>
                </td>
          	</tr>
          	<tr>
          	...
          	<tr>
           	  <td align="right">&nbsp;</td>
           	  <td><span class="listtitle">
           	    <input type='submit' class="form-button" id="btn_01" value="Create Account" />
           	  </span></td>
          	</tr>
        </table>     </div></form>
    </div>
...
<img src="images/parte.png" width="200" height="9" /><br>
<a href="https://www.facebook.com/DKInframundo"><img src="images/facebook-icon.png" width="48" height="48" alt="DK Inframundo"/></a><a href="javascript: void(0)" onClick="window.open('chat.html','windowname1','width=810, height=410');return false;"></a><a href="chat.html"><img src="images/chat.png" width="48" height="48" alt="Chat" /></a><br><br><br>
