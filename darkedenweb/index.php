...
/* DATABASE LOOP COMMENTED OUT FOR VIEW MODE
...
?>
<img src="images/parte.png">
<div style="background:url(../images/servidor.png) no-repeat;"><div class='memin'>
<? if($_SESSION['user_id'])
{
?>
<a href="my_account.php"><img src="images/my_account.png" width="200" height="44" /></a>
<?
}
?></div><div class='memin'></div><br></br><br></br></span>
</div>
</div>
    <div id="content-middle">
    <div></div>
     <div id="container">
     <span style="font-size:11px;margin-top:5px;float:right;"></a></span>
     <div id="fb-root"></div>
     ...
     }(document, 'script', 'facebook-jssdk'));</script><img src="images/parte.png" width="182"><img src="images/parte.png" width="182"><img src="images/parte.png" width="182">
 <body>
     <div id="wrapper">
       <div id="Accordion1" class="Accordion" tabindex="0">
         <div class="AccordionPanel">
           <div class="AccordionPanelTab">Update</div>
           <div class="AccordionPanelContent"><a href="javascript: void(0)"
  onclick="window.open('noticias/5.html',
  'windowname1',
  'width=564, height=400');
  return false;"><img src="images/updatea.gif" width="45" height="12" /><span class="texto">Parche V1 - 14/10/2012</a></div>
         </div>
         <div class="AccordionPanel">
           <div class="AccordionPanelTab">Notice</div>
           <div class="AccordionPanelContent"> <a href="javascript: void(0)"onclick="window.open('noticias/4.html',
  'windowname1',
  'width=564, height=400');
  return false;"><img src="images/notice.gif" width="45" height="12" /><span class="texto">Apertura Oficial - 14/10/2012</span></a></div>
         </div>
         <div class="AccordionPanel">
           <div class="AccordionPanelTab">Event</div>
           <div class="AccordionPanelContent"><a href="javascript: void(0)"onclick="window.open('noticias/6.html',
  'windowname1',
  'width=564, height=400');
  return false;"><img src="images/evento.gif" width="45" height="12" /><span class="texto">Evento de Navidad</span></a></div>
         </div>
       </div>
     </div>
    <script type="text/javascript">
...
<img src="images/parte.png" width="182"><img src="images/parte.png" width="182"><img src="images/parte.png" width="182">
...
<table width="202" height="143" border="0" class="servidor">
  <tr>
    <td><table width="200" border="0">
      <tr>
        <td><center><?php 
/* DATABASE QUERIES COMMENTED OUT FOR VIEW MODE
...
echo '<b><font color="#00FF00">Online:</font></b> 42<p>Accounts:  1250';
?></td>
      </tr>
    </table></td>
  </tr>
...
<tbody><tr>
<td>
<table align="center" border="0" cellpadding="0" cellspacing="0" height="118" width="118">
<tbody><tr>
<td bgcolor="black">
<table border="0" cellpadding="0" cellspacing="0" height="118" width="118">
<tbody><tr>
<td style="background-color: black;" onMouseOver="this.style.backgroundColor='orange'" onMouseOut="this.style.backgroundColor='black'" align="center" valign="middle"><a href="market_buy.php?id=74"><img src="images/market/c/74.jpg" alt="" border="0" height="110" width="110"></a></td>
</tr>
</tbody></table>
</td>
</tr>
...
<tr>
<td align="center" height="2"> Premiun Card-B</td>
</tr>
<tr>
<td align="center">&nbsp;</td>
</tr>
...
<table border="0" cellpadding="0" cellspacing="0" height="118" width="118">
<tbody><tr>
<td style="background-color: black;" onMouseOver="this.style.backgroundColor='orange'" onMouseOut="this.style.backgroundColor='black'" align="center" valign="middle"><a href="market_buy.php?id=62"><img src="images/market/c/62.jpg" alt="" border="0" height="110" width="110"></a></td>
</tr>
</tbody></table>
</td>
</tr>
...
<tr>
<td align="center" height="2">Experience Hourglass</td>
</tr>
<tr>
<td align="center">&nbsp;</td>
</tr>
...
<table border="0" cellpadding="0" cellspacing="0" height="118" width="118">
<tbody><tr>
<td style="background-color: black;" onMouseOver="this.style.backgroundColor='orange'" onMouseOut="this.style.backgroundColor='black'" align="center" valign="middle"><a href="market_buy.php?id=59"><img src="images/market/c/59.jpg" alt="" border="0" height="110" width="110"></a></td>
</tr>
</tbody></table>
</td>
</tr>
...
<tr>
<td align="center" height="2"> Sub-Inventory</td>
</tr>
<tr>
<td align="center">&nbsp;</td>
</tr>
...
<table border="0" cellpadding="0" cellspacing="0" height="118" width="118">
<tbody><tr>
<td style="background-color: black;" onMouseOver="this.style.backgroundColor='orange'" onMouseOut="this.style.backgroundColor='black'" align="center" valign="middle"><a href="market_buy.php?id=53"><img src="images/market/c/53.jpg" alt="" border="0" height="110" width="110"></a></td>
</tr>
</tbody></table>
</td>
</tr>
...
<tr>
<td align="center" height="2">Trans Item Kit</td>
</tr>
<tr>
<td align="center">&nbsp;</td>
</tr>
...
<table border="0" cellpadding="0" cellspacing="0" height="118" width="118">
<tbody><tr>
<td style="background-color: black;" onMouseOver="this.style.backgroundColor='orange'" onMouseOut="this.style.backgroundColor='black'" align="center" valign="middle"><a href="market_buy.php?id=4"><img src="images/market/c/4.jpg" alt="" border="0" height="110" width="110"></a></td>
</tr>
</tbody></table>
</td>
</tr>
...
<tr>
<td align="center" height="2"> Hope Aura Stone</td>
</tr>
<tr>
<td align="center">&nbsp;</td>
</tr>
...
<table border="0" cellpadding="0" cellspacing="0" height="118" width="118">
<tbody><tr>
<td onMouseOver="this.style.backgroundColor='orange'" onMouseOut="this.style.backgroundColor='black'" align="center" valign="middle"><a href="market_buy.php?id=14"><img src="images/market/c/14.jpg" alt="" border="0" height="110" width="110"></a></td>
</tr>
</tbody></table>
</td>
</tr>
...
<tr>
<td align="center" height="2">Weapon Mixing Forge</td>
</tr>
<tr>
<td align="center">&nbsp;</td>
</tr>
